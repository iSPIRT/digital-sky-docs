# Import Drone Applications List

API for admin to list all Import Drone applications which are not in DRAFT state

**URL** : `/api/applicationForm/importDroneApplication/getAll`
